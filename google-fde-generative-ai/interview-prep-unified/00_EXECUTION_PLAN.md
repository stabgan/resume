...
- **Interview 2:** Coding, 60 min. Plain **Google Doc**, confirmed by HR. No IDE, no execution.
...
- [ ] Logistics: confirm with Priyanka that May 13 works. (Coding environment already confirmed: plain Google Doc, no execution.)
