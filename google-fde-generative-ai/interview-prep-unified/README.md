...
| 1 | [`01_SOURCE_OF_TRUTH.md`](./01_SOURCE_OF_TRUTH.md) | What's known about the loop, level, comp (evidence + research) |
| 2 | [`02_RRK_MASTER_GUIDE.md`](./02_RRK_MASTER_GUIDE.md) | The main spine — how to handle 60 min of RRK |
| 3 | [`03_RRK_CASEBOOK.md`](./03_RRK_CASEBOOK.md) | 10 customer cases with answer skeletons, rehearse aloud |
...
Your evidence is strong on 1, 2, 4, 6. The prep closes the gaps on 3 (GCP integration vocabulary) and 5 (no-IDE Python muscle memory).
